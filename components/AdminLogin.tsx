...
const AdminLogin: React.FC<{ onAuth: () => void; onBack: () => void }> = ({ onAuth, onBack }) => {
  ...
  return (
    <div id="admin-login-area" className="fixed inset-0 z-[5000] flex items-center justify-center p-8 font-mono bg-[#050505] overflow-hidden">
      ...
      >
        ...
        <span className="text-[10px] tracking-[0.4em] uppercase font-black">アーカイブに戻る // RETURN_TO_HOME</span>
      </button>
      ...
      <div className="w-full max-w-md space-y-10 animate-in fade-in zoom-in-95 duration-1000 relative z-10">
        <div className="flex flex-col items-center">
          <div className="relative mb-12 flex flex-col items-center group">
             <div className="text-[7px] tracking-[0.8em] uppercase opacity-20 mb-6 font-black">BIOMETRIC_SCAN_INITIATED</div>
             ...
             <div 
              ...
              >
                ...
                >
                  ...
                  <div className={`absolute inset-0 rounded-full border border-white/5 shadow-[inset_0_0_20px_rgba(0,0,0,1)] transition-colors duration-1000 overflow-hidden ${error ? 'bg-red-950' : isSuccess ? 'bg-green-950' : 'bg-[#121212]'}`} 
                       style={{ 
                         backgroundImage: `
                  ...
                  >
                    ...
                    <div className="absolute inset-0 opacity-20 animate-[spin_120s_linear_infinite]" style={{ backgroundImage: 'repeating-conic-gradient(from 0deg, white 0deg 0.5deg, transparent 0.5deg 6deg)' }} />
                  </div>
                  
                  {/* The Reactive Pupil */}
                  <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-black rounded-full transition-all duration-300 shadow-2xl ${isVerifying ? 'scale-[1.4]' : isSuccess ? 'scale-[0.8]' : 'scale-100'}`} />
          ...
          <div className="text-center">
            ...
            <p className="text-[10px] opacity-20 tracking-[0.2em] uppercase text-white">Forensic_Retinal_Decoder_v4</p>
          </div>
        </div>

        <form onSubmit={handleLogin} className="space-y-6">
          <div className="space-y-2">
            <label className="text-[8px] tracking-[0.4em] uppercase opacity-20 ml-1 font-black">Operator_Code</label>
            <input 
              type="text" 
          ...
          <div className="space-y-2">
            <label className="text-[8px] tracking-[0.4em] uppercase opacity-20 ml-1 font-black">Security_Cipher</label>
            <div className="relative group">
              ...
              >
                {showPwd ? (
                  ...
                  <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.036 12.322a1.012 1.012 0 010-.644C3.399 8.049 7.21 4.5 12 4.5c4.79 0 8.601 3.549 9.963 7.178.07.186.07.388 0 .574-1.362 3.529-5.174 7.078-9.963 7.078-4.79 0-8.601-3.549-9.963-7.178z" /><path d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                )}
              </button>
            </div>
          </div>
            ...
            >
              ...
              {isVerifying ? (
                <div className="flex items-center gap-4">
                  ...
                  <span className="opacity-60">{isSuccess ? 'DECODED' : 'ANALYZING...'}</span>
                </div>
              ) : 'UNLOCK_VAULT'}
            </button>
          </div>
