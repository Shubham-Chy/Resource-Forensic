...
const SecurityGate: React.FC<SecurityGateProps> = ({ disabled = false }) => {
  ...
  useEffect(() => {
    ...
    const observer = new MutationObserver(() => {
      const gateIsActive = !!document.querySelector(
        ...
        <div className="flex flex-col items-center gap-12 text-center">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-center gap-6 mb-4">
              ...
              <div className="text-[11px] tracking-[0.8em] uppercase font-black text-red-500 animate-pulse">
                FILTER_SHIELD_DETECTED
              </div>
              <div className="h-[2px] w-16 bg-red-600/30" />
            </div>
            ...
            <h2 className="text-6xl md:text-9xl font-black tracking-tighter leading-none flex flex-col items-center">
              ...
              <span className="text-4xl md:text-6xl mt-4 tracking-[0.2em] font-black">
                立入禁止
              </span>
            </h2>

            <p className="text-[9px] md:text-[11px] tracking-[0.4em] uppercase font-bold opacity-30 mt-10 max-w-lg mx-auto leading-loose">
              AD-BLOCKING AGENTS HAVE COMPROMISED THE FORENSIC INTEGRITY OF THIS
              TERMINAL. TO DECODE THE ARCHIVE, ALL EXTERNAL INTERFERENCE MUST BE
              NEUTRALIZED.
            </p>
          </div>
          ...
          <div className="relative w-48 h-48 md:w-56 md:h-56">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="flex flex-col items-center">
                ...
                <span className="text-[8px] tracking-[0.5em] font-black opacity-20 uppercase">
                  PROTOCOL_ERROR
                </span>
              </div>
            </div>
